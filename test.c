...
int main() {
    ...
    if (readImageFile("C:/Users/PC/Desktop/Empotrados/R.bmp", &buffer, &sizeOfBuffer) == 0) {
        ...
        if (writeImageFile("C:/Users/PC/Desktop/Empotrados/restored_image.bmp", restoredBuffer, sizeOfBuffer) == 0) {
